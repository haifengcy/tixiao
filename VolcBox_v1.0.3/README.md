...
[🌐 访问官方主页](https://volcbox.pages.dev) · [📦 下载插件安装包 (.zip)](https://volcbox.pages.dev/VolcBox_v1.0.3.zip) · [🐛 提交反馈 / Issue](https://github.com/haifengcy/Figma-VolcBox/issues)
...
1. **下载安装包**：
   直接下载最新 [VolcBox_v1.0.3.zip](https://volcbox.pages.dev/VolcBox_v1.0.3.zip) 并解压到本地（或 `git clone https://github.com/haifengcy/Figma-VolcBox.git`）；
2. **在 Figma 中导入**：
