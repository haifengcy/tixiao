...
[🌐 访问官方主页](https://volcbox.pages.dev) · [📦 下载插件安装包 (.zip)](https://volcbox.pages.dev/VolcBox_v1.0.1.zip) · [🐛 提交反馈 / Issue](https://github.com/haifengcy/Figma-VolcBox/issues)
...
1. **获取插件安装包**：
   - 直接下载最新 [VolcBox_v1.0.1.zip](https://volcbox.pages.dev/VolcBox_v1.0.1.zip) 并解压到本地文件夹；
   - 或使用 Git 克隆本仓库：
     ```bash
